...
def api_template_builder_onlyoffice_config(session_id: str):
    ...
    _ai_plugin_url = f"{_pub_scheme}://{request.host}/api/ai-plugin/config.json"
    _ai_plugin_guid = "asc.{c4d5e6f7-a1b2-4c3d-8e9f-012345678901}"
    payload["editorConfig"]["plugins"] = {
        "pluginsData": [_params_plugin_url, _ai_plugin_url],
        # Auto-open Параметры 1С panel; AI plugin is available via the Plugins menu
